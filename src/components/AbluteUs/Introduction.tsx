...
const Introduction = () => {
  ...
  Introduction
    ...
    <div className="w-[90%] mx-auto ">
        ...
        <p className="my-4 font-montserrat">
        You can count on our security team to monitor your hosted IT infrastructure and network environment 24X7 for better safety. Our team continuously monitors and prevents intrusive hackers, bugs, malware, and espionage to keep your system operational. You can rest assured that only the members of your authorized team and you will have access to the files and programs
         you host with us.
        </p>
    ...
    <h1 className="text-center font-kanit font-semibold text-4xl py-4">Data Center Partners
    </h1>

    <p className="flex "> 
    <span> ⮚</span> Our data centers are among the highest rated in the industry, allowing us to deliver a superior hosting experience to users. We have collaborated with data centers in the cities of New York, Dallas, and Phoenix that is HIPAA and HITECH certified to provide the best hosting experience. Get the advantage of seamless access to the files and applications you host, powered by our state-of-art data centers.
    </p>

    <p className="flex my-4">
    <span> ⮚</span> With Tier-III and Tier-IV data centers that are fully SSAE-18 Type-II (SOC-1/SOC-2) certified and HIPAA and HITECH audited, you can be assured that your data is safe and secure. Our data centers deliver seamless access to your hosted apps and data with the highest level of security owing to powerful cloud resources and high-tech components. You can be sure that our data centers can withstand extreme weather conditions in addition to power shortages and deliver a seamless connection.
    </p>

    <p className="flex my-4">
    <span> ⮚</span> Our five data centers and one network point of presence (PoP) are strategically positioned around the globe, making it easy to access all of the major domestic and international connectivity points. Make your business more successful by leveraging our Local Internet Exchange and 2x10G, 4x10G, or 1x100G connectivity in our U.S. locations.

    </p>

    <p className="flex">
    <span> ⮚</span>We provide you with colocation services that are extremely safe, redundant, and dependable from several locations across the world. Choosing the right data center location can make all the difference to your company. Your ability to give them a better experience depends on how near you are to them. You can guarantee a high level of availability and 100% availability for your services with worldwide interconnection points and solid network infrastructure. Our high-bandwidth connectivity, business-grade security, and great performance provide your company a solid foundation. See each of our locations: (1) Los Angeles, California (Network PoP) (2) Phoenix, Arizona (3) Seattle, Washington (4) Atlanta, Georgia (5) Chicago, Illinois (6) Ashburn, Virginia
    </p>

    <h1 className="text-center font-kanit font-semibold my-4 text-2xl">Data Center Security </h1>

    <h2 className="p-3 text-white rounded-xl text-center md:text-start bg-red-600 border mt-5 font-kanit font-semibold text-2xl">Enterprise-level security protocols:
    </h2>
     
    <p className="flex my-4">
    <span> ⮚</span>We use intrusion detection and mitigation systems, network anti-virus software, cutting-edge Cisco firewalls, and other defense technologies as part of our security systems.
    </p>
    <p className="flex my-4">
    <span> ⮚</span > We host all of our applications on reliable hardware from vendors such as HP, Cisco, Network Appliance, etc.
    </p>

    <p className="flex my-4">
    <span> ⮚</span> Our data centers include top-notch infrastructure, including generators, top-tier UPS, and HVAC. This essentially makes us impervious to environmental problems. Our servers at Winscloud are powered and cooled by redundant power supplies.
    </p>
    <p className="flex my-4">
    <span> ⮚</span>We guarantee 99.9% server hardware reliability with our Server Cluster solution
    </p>
    <p className="flex my-4">
    <span> ⮚</span>Servers are connected to our redundant switched and routed network, which is geared towards high performance and uptime at all times. Our mission is to provide the highest quality hardware to all our customers, regardless of their plan.
    </p>

    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 justify-items-center ">
  <div className="md:w-[80%] w-full border-4 rounded-lg border-red-600 bg-amber-100 text-gray-700 p-2">
    <h1 className="font-bold font-kanit text-blue-500 text-center text-2xl">High performance</h1>
    <p className=" text-center font-josefin">
      SSD servers that operate at breakneck speeds deliver great performance instantly. Access your apps without interruption from any location and on any device.
    </p>
  </div>
...
<h2 className="p-3 text-white rounded-xl text-center md:text-start bg-red-600 border mt-5 font-kanit font-semibold text-2xl">Network speed :
</h2>
...
Additionally, we take all essential precautions to prevent unwanted access, including 24/7 network scanning, Surveillance cameras, on-site security officers, and other measures.
  ...
  <h2 className="p-3 text-white rounded-xl text-center md:text-start bg-red-600 border mt-5 font-kanit font-semibold text-2xl">HIPPA Compliance
  </h2>
...
<ul className="list-disc list-outside pl-5  rounded-lg">
  ...
  <li>Highly qualified and knowledgeable individuals to monitor data security.</li>
  <li>Control of application access.</li>
