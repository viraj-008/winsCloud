    ...
    <>
        <div className="w-full flex bg-[url('/images/Home/cloude.jpg')] bg-cover h-[600xp] bg-center  px-5  items-center">
          ...
          <div className='w-full   text-center  md:text-left'>
            <motion.h1
              className="ttext-slate-100 mt-[80px] md:mt-[100px] font-bold font-josefin text-3xl md:text-6xl text-orange-600 "
            ...
            <Link to="/trial">  <button className='mx-auto md:mx-0 flex border my-5 md:my-16 bg-green-600 text-xl md:text-4xl px-6 md:px-12 text-white font-josefin py-2 rounded-lg'>
              Request a Free Demo
            </button></Link>
          </div>
        </div>
      ...
      <div className='px-5  md:px-20'>
        ...
        <div className="flex flex-col md:flex-row justify-between mt-12 items-center">
          {/* Text on the left */}
          <div className="w-full text-justify md:w-[55%] text-gray-600 font-josefin md:pr-8">
            <p>
  ...
  <div>
    <p>
      ...
      Our hosting plans can be customized to your business needs and are easy on the pocket. You can choose between our Shared and Dedicated Hosting Plans.
        ...
        <div className='border md:w-[90%] mx-auto rounded-lg my-8 p-2 bg-red-800 shadow-lg'>
      ...
      <div className='w-[90%] mx-auto'>
        ...
        <p className=' font-josefin text-justify text-gray-600 my-4 '>We help set-up a practical, secure,
