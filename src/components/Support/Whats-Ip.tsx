...
function WhatsIp() {
  return (
    <>
        <div className="w-full flex bg-[url('/images/Home/intro.jpg')] bg-cover bg-center  pt-10 px-5 md:px-40 items-center min-h-[430px]">
      <div className="w-full text-center ">
        <h1 className="text-white font-anton text-3xl md:text-6xl leading-tight">
        Whats My IP
        </h1>
        <h1 className="text-white bg-blue-600 rounded-lg p-2 my-3 text-3xl  leading-tight">
