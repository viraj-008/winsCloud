    ...
    <>
      <header className="w-full flex bg-[url('/images/Home/sage1.jpg')] bg-cover bg-center pt-20 px-5 md:px-20 items-center">
        <div className="w-full text-center md:text-left">
          ...
          <Link to="/trial" aria-label="Get Sage 100 Hosting">
      ...
      <main>
        ...
        <section className="flex flex-col md:flex-row justify-between p-4 md:p-8">
          ...
          <figure className="w-full md:w-[50%] flex justify-center mt-6 md:mt-0">
            <img
              ...
              alt="Sage 100 Hosting Interface"
            />
          </figure>
        </section>
        ...
        <section className="p-4">
          ...
          <p className="text-center font-montserrat my-6 px-4">
            Sage 100 ERP application hosting can manage accounting, manufacturing, sales, inventory, and warehouse. It also helps businesses by generating insights which can help predict customer behaviors, ultimately helping meet their changing demands. While the desktop software is a perfect solution to manage the day-to-day business operations, Sage 100 cloud hosting blends it with the power of cloud – allowing businesses to grow seamlessly.
          </p>
        </section>
        ...
        <section className="w-[90%] mt-5 mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          <article className="bg-white/20 backdrop-blur-lg p-6 border hover:text-white hover:bg-green-500 transition-all duration-300 shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
            <img
              ...
              alt="Round-the-Clock Accessibility"
              className="mx-auto hover:scale-125 hover:translate-y-2 transition-all duration-300 mb-4 w-28"
            />
            <h3 className="font-bold text-xl mb-2 font-kanit">Round-the-Clock Accessibility</h3>
          ...
          <article className="bg-white/20 backdrop-blur-lg p-6 hover:text-white hover:bg-green-500 transition-all duration-300 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
            <img src="images/logo/qb3.webp" alt="Multi-User Collaboration" className="mx-auto hover:scale-125 hover:translate-y-2 transition-all duration-300 mb-4 w-28" />
          ...
          <article className="bg-white/20 hover:bg-green-500 hover:text-white transition-all duration-300 backdrop-blur-lg p-6 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
            <img src="images/logo/qb1.webp" alt="No Upfront Costs" className="mx-auto hover:scale-125 hover:translate-y-2 transition-all duration-300 mb-4 w-28" />
            <h3 className="font-bold text-xl mb-2  font-kanit">No Upfront Costs</h3>
        ...
        <section className="max-w-3xl mx-auto mt-10 border rounded-lg shadow-lg overflow-hidden">
          <h2 className="text-2xl text-center font-bold font-kanit mt-8 px-8">
            Sage 100 Cloud Hosting Frequently Asked Questions
          </h2>
          {faqs.map((faq, index) => (
