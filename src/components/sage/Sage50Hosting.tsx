    ...
    <>
      <header className="w-full flex bg-[url('/images/Home/sage1.jpg')] bg-cover bg-center pt-20 px-5 md:px-20 items-center">
        <div className="w-full text-center md:text-left">
          ...
          <Link to="/trial" aria-label="Consult a Hosting Expert">
      ...
      <main>
        ...
        <section className="flex flex-col md:flex-row justify-between p-4 md:p-8">
          <article className="w-full font-josefin text-justify text-gray-600 md:w-[45%]">
        ...
        <section className="w-[90%] mt-5 mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <article className="bg-white/20 backdrop-blur-lg p-6 hover:text-white hover:bg-green-500 transition-all duration-300 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
            <img
              ...
              alt="Maximum Uptime Guarantee"
              className="mx-auto hover:scale-125 hover:translate-y-2 transition-all duration-300 mb-4 w-28"
            />
            <h3 className="font-bold text-xl mb-2 font-kanit">Maximum Uptime Guarantee</h3>
          ...
          <article className="bg-white/20 hover:bg-green-500 hover:text-white transition-all duration-300 backdrop-blur-lg p-6 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
            <img
              ...
              className="mx-auto hover:scale-125 hover:translate-y-2 transition-all duration-300 mb-4 w-28"
            />
            <h3 className="font-bold text-xl mb-2 font-kanit">Customizable Pricing</h3>
          ...
          <article className="bg-white/20 hover:bg-green-500 hover:text-white transition-all duration-300 backdrop-blur-lg p-6 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
            <img
              ...
              className="mx-auto hover:scale-125 hover:translate-y-2 transition-all duration-300 mb-4 w-28"
            />
            <h3 className="font-bold text-xl mb-2 font-kanit">All Backed Up</h3>
            <p className="text-gray-800 font-montserrat transition-all duration-300">
          ...
          <article className="bg-white/20 hover:bg-green-500 hover:text-white transition-all duration-300 backdrop-blur-lg p-6 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
            <img
              src="images/logo/qb1.webp"
              alt="24/7/365 Support"
              className="mx-auto hover:scale-125 hover:translate-y-2 transition-all duration-300 mb-4 w-28"
            />
            <h3 className="font-bold text-xl mb-2 font-kanit">24/7/365 Support</h3>
            <p className="text-gray-800 font-montserrat transition-all duration-300">
        ...
        <section className="my-12 w-[90%] mx-auto">
          ...
          <p className="text-center font-montserrat text-sm mt-2">
            The advanced accounting and payroll software helps businesses carry out several key operations such as managing cash flows, sales, invoices, and monitoring payments. The powerful features of the Sage 50 application facilitate handling of a plethora of accounting operations like monitoring revenue, day-to-day expenses, and anticipating future cash flows. Sage 50 hosting is a perfect solution for accountants & bookkeepers, and for small and medium firms operating in manufacturing, construction, retail and wholesale businesses, IT services, law firms, food and beverage, etc. Certain large size businesses also find Sage 50 useful.
          </p>
          <p className="text-center font-montserrat my-6">
            In today’s world where businesses need to be caught up with the technological advances, Sage 50 hosting plays a key role in their survival. Cloud computing saves these small businesses time, money and effort to stay updated with their business needs and significantly enhances productivity.
          </p>

          <div className="flex flex-col md:flex-row mt-8">
            <article className="md:w-[50%] space-y-4 font-montserrat text-sm p-3">
              <p>
                <span className="font-kanit font-bold">Anytime, Anywhere Access- </span>
                Sage 50 hosting solution provides 24/7 access to critical financial data, empowering business owners to stay up to date with their inventory status, daily sales, and other updates from anywhere in the world.
              </p>
              <p>
                <span className="font-kanit font-bold my-6">High level of productivity- </span>
                With business data at your fingertips and multiple device compatibility, Sage 50 hosting allows remote teams to work on the same data set simultaneously, promoting uninterrupted productivity.
              </p>
            </article>
            ...
            <article className="md:w-[50%] space-y-4 p-3 font-montserrat text-sm">
              <p>
                ...
                With Sage 50 hosting, multiple users can access the same data saved on the cloud hosted application, share information, and ensure timely completion of critical projects by working in real time.
              </p>
              <p>
                <span className="font-kanit font-bold">Cost Effective Solution-</span>
                With Sage 50, small businesses can save big on heavy IT infrastructure, floor space, and in-house staff needed for its maintenance. Sage 50 hosting providers charge a minimal amount for all these services.
              </p>
            </article>
          </div>
        </section>
        ...
        <section className="max-w-3xl mx-auto mt-10 border rounded-lg shadow-lg overflow-hidden">
          <h2 className="text-2xl text-center font-bold font-kanit mt-8 px-8">
            Sage 50 Cloud Hosting Frequently Asked Questions
          </h2>
          {faqs.map((faq, index) => (
