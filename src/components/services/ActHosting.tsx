...
const ActHosting = () => {
  return (
    <>
    <div className="w-full flex bg-[url('/images/Home/server.webp')] bg-cover bg-center  pt-20 px-5 md:px-20 items-center min-h-[330px] md:min-h-[430px]">
  ...
  <div className="p-2">
    ...
    <h1 className="text-center  font-semibold font-serif text-xl">ACT Hosting Services offers seamless and powerful CRM management</h1>
    {/* Text Section */}
    ...
    <div className=" w-[90%] mx-auto  flex justify-center mt-8">
      <img className="h-48 md:h-80 border-2 border-black rounded-lg object-cover" src="./images/logo/act-soft.webp" alt="QuickBooks Hosting" />
    </div>
  </div>
  ...
  Rely on Our ATX Hosting Solutions for Unmatched Cloud Server Performance
    ...
    <p className="text-center px-4 font-montserrat">ATX Hosting: Simplify finances, access anywhere, anytime, for peace of mind
</p>
...
Well-equipped Data centers
  ...
  What can you do with us
    ...
    <div className="bg-white/20  backdrop-blur-lg p-6 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
      ...
      <h2 className="font-bold text-xl mb-2   bg-red-600 text-white font-josefin py-3 rounded-lg">Effortless Tax Management: ATX Cloud Hosting Solutions
      </h2>
    ...
    <div className="bg-white/20  backdrop-blur-lg p-6 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
      ...
      <h2 className="font-bold text-xl mb-2   bg-red-600 text-white font-josefin py-3 rounded-lg">Seamless Tax Management Anywhere: Explore ATX Remote Access
      </h2>
      <p className="text-gray-700  p-2 rounded-md shadow-lg  font-montserrat transition-all duration-300">
    ...
    <div className="bg-white/20  backdrop-blur-lg p-6 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
      ...
      <h2 className="font-bold text-xl mb-2   bg-red-600 text-white font-josefin py-3 rounded-lg">Optimize CRM Operations with Top-Tier Tax Solutions: ATX Hosting in the USA
      </h2>
      <p className="text-gray-700  p-2 rounded-md shadow-lg  font-montserrat transition-all duration-300">
    ...
    <div className="flex flex-col md:flex-row justify-around mt-10 px-4">

    <Link to="https://www.act.com/products/ ">   
