...
const AxtHosting = () => {
  ...
  <div className="  justify-center  p-4 m">
    ...
    <h1 className="text-center font-semibold font-kanit text-2xl">ATX Hosting: Stay ahead of the competition with Winscloud Solutions
    </h1>
    {/* Text Section */}
    ...
    <div className=" w-[90%] mx-auto  flex justify-center mt-8">
      <img className="h-48 md:h-80 border-2 border-black rounded-lg object-cover" src="./images/logo/atx.webp" alt="QuickBooks Hosting" />
    </div>
  </div>
  ...
  Simplified ACT Hosting: Our Cloud, Your Financial Data
    ...
    <p className="text-center px-4 font-montserrat">ACT! Hosting: Simplify finances, access anywhere, anytime, for peace of mind</p>
    ...
    <div className="bg-white/20 backdrop-blur-lg p-6 hover:text-white hover:bg-green-500 transition-all duration-300 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
      ...
      <h2 className="font-bold text-xl mb-2 font-kanit">All Add-ons
      </h2>
    ...
    <div className="bg-white/20 hover:bg-green-500 hover:text-white transition-all duration-300 backdrop-blur-lg p-6 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
      <img src="images/logo/qb1.webp" alt="Data Security and Recovery" className="mx-auto hover:scale-125 hover:translate-y-2 transition-all duration-300 mb-4 w-28" />
      <h2 className="font-bold text-xl mb-2  font-kanit">Every Time Support</h2>
      <p className="text-gray-800 font-montserrat transition-all duration-300">
    ...
    <div className="bg-white/20 hover:bg-green-500 hover:text-white transition-all duration-300 backdrop-blur-lg p-6 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
      <img src="images/logo/qb1.webp" alt="Data Security and Recovery" className="mx-auto hover:scale-125 hover:translate-y-2 transition-all duration-300 mb-4 w-28" />
      <h2 className="font-bold text-xl mb-2  font-kanit">High security </h2>
      <p className="text-gray-800 font-montserrat transition-all duration-300">
  ...
  What can you do with ACT Hosting?
  </h1>
    ...
    <div className="bg-white/20  backdrop-blur-lg p-6 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
      ...
      <h2 className="font-bold text-xl mb-2   bg-red-600 text-white font-josefin py-3 rounded-lg">Elevate CRM Efficiency with ACT Hosting Solutions
      </h2>
    ...
    <div className="bg-white/20  backdrop-blur-lg p-6 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
      ...
      <h2 className="font-bold text-xl mb-2   bg-red-600 text-white font-josefin py-3 rounded-lg">Optimize CRM Efficiency with ACT Hosting Providers
      </h2>
      <p className="text-gray-700  p-2 rounded-md shadow-lg  font-montserrat transition-all duration-300">
    ...
    <div className="bg-white/20  backdrop-blur-lg p-6 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
      ...
      <h2 className="font-bold text-xl mb-2   bg-red-600 text-white font-josefin py-3 rounded-lg">Unlock Flexibility with ACT Remote Access Solutions
      </h2>
      <p className="text-gray-700  p-2 rounded-md shadow-lg  font-montserrat transition-all duration-300">
    ...
    <div className="bg-white/20  backdrop-blur-lg p-6 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
      ...
      <h2 className="font-bold text-xl mb-2   bg-red-600 text-white font-josefin py-3 rounded-lg">Optimize CRM Operations with ACT Cloud Hosting Solutions
      </h2>
      <p className="text-gray-700  p-2 rounded-md shadow-lg  font-montserrat transition-all duration-300">
