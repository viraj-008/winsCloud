  ...
  return (
    <>
      <section className="md:min-h-[90vh] rounded-b-3xl flex items-center bg-gradient-to-br from-[#0f172a] via-[#1e3a8a] to-black text-white px-6 py-12 lg:py-0">
         ...
         <Helmet>
          <title>Doc-it Hosting | Secure Cloud Document Management by Winscloud</title>
          <meta name="description" content="Streamline workflows with Winscloud’s Doc-it Hosting. Enjoy secure, cost-effective document management—Get started today and simplify your operations!" />
        </Helmet>
      ...
      <main>
        <section>
          <h2 className='text-3xl text-center py-4 -mb-5 md:-mb-0 w-[90%] mx-auto font-bold font-montserrat text-textPrimary'>
        ...
        <section className="flex flex-col-reverse md:flex-row items-center gap-8 px-4 py-8 md:px-16 md:py-4">
        ...
        <div className="h-full my-8 w-full bg-gradient-to-br from-blue-50 to-gray-100 py-6  ">
          ...
          <p className="text-center px-4 text-xl font-montserrat mb-10 text-gray-800 max-w-6xl mx-auto">Doc-it hosting: Simplify finances, access anywhere, anytime, for peace of mind
          </p>
