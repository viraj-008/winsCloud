...
const DocItHosting = () => {
  ...
  <div className="  justify-center  p-4 m">
    ...
    <div className=" w-[90%] mx-auto  flex justify-center mt-8">
      <img className="h-48 md:h-80 border-2 border-black rounded-lg object-cover" src="./images/logo/doc-it.webp" alt="QuickBooks Hosting" />
    </div>
  </div>
  ...
  Benefits of Winscloud Doc-it Hosting
    ...
    <p className="text-center px-4 font-montserrat">Benefits of Winscloud Doc-it Hosting
</p>
  ...
  What can you do with us
    ...
    <div className="bg-white/20  backdrop-blur-lg p-6 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
      ...
      <h2 className="font-bold text-xl mb-2   bg-red-600 text-white font-josefin py-3 rounded-lg">Efficient Document Management: Explore Doc-it Hosting Solutions
      </h2>
    ...
    <div className="bg-white/20  backdrop-blur-lg p-6 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
      ...
      <h2 className="font-bold text-xl mb-2  px-3 bg-red-600 text-white font-josefin py-3 rounded-lg">Boost Your Document Management: Embrace Hosted Doc-it Solutions
      </h2>
      <p className="text-gray-700  p-2 rounded-md shadow-lg  font-montserrat transition-all duration-300">
    ...
    <div className="bg-white/20  backdrop-blur-lg p-6 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
      ...
      <h2 className="font-bold text-xl mb-2  px-3 bg-red-600 text-white font-josefin py-3 rounded-lg">Reliable Infrastructure, Trusted Support: Hosting Providers at Your Service
      </h2>
      <p className="text-gray-700  p-2 rounded-md shadow-lg  font-montserrat transition-all duration-300">
    ...
    <div className="bg-white/20  backdrop-blur-lg p-6 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
      ...
      <h2 className="font-bold text-xl mb-2 px-3  bg-red-600 text-white font-josefin py-3 rounded-lg">Efficient Document Management: Unleash the Power of Cloud Doc-it
