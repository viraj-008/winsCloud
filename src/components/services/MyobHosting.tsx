  ...
  return (
    <>
      <section className="md:min-h-[90vh] rounded-b-3xl flex items-center bg-gradient-to-br from-[#0f172a] via-[#1e3a8a] to-black text-white px-6 py-12 lg:py-0">
         ...
         <Helmet>
          <title>MYOB Hosting | Secure Cloud MYOB Access by Winscloud</title>
          <meta name="description" content="Access MYOB anytime, anywhere with Winscloud. Track GST, PAYG, bank feeds & more—start your cloud MYOB journey today with expert support!" />
        </Helmet>
      ...
      <main>
        <section>
          <h2 className='text-3xl text-center mt-4 -mb-4 md:-mb-0  w-[90%]  mx-auto font-bold font-montserrat text-textPrimary'>
            MYOB Hosting: Streamline Finances for Growth and Prosperity
          </h2>
        </section>

        <section className="flex flex-col-reverse md:flex-row items-center gap-8 px-4 py-8 md:px-16 m">
        ...
        <div className="h-full my-8 w-full bg-gradient-to-br from-blue-50 to-gray-100  py-6  ">
          <h2 className="font-bold w-[] text-4xl mt-3 font-inter  my-5  text-center text-textPrimary">
            Advantages of Winscloud MYOB Hosting Solutions
          </h2>
          <p className="text-center px-3 text-xl font-montserrat mb-10 text-gray-800 max-w-6xl mx-auto">MYOB Hosting: Simplify finances, access anywhere, anytime, for peace of mind
          </p>
        ...
        <div className="mt-8 w-[90%] mx-auto bg-white">
