...
const MyobHosting = () => {
  ...
  <div className="  p-3">
    ...
    <h1 className="text-center font-semibold font-serif text-gray-600 text-2xl">MYOB Hosting: Streamline Finances for Growth and Prosperity
    </h1>
    {/* Text Section */}
  ...
  Advantages of Winscloud MYOB Hosting Solutions
    ...
    <p className="text-center px-4 font-montserrat">MYOB Hosting: Simplify finances, access anywhere, anytime, for peace of mind
</p>
  ...
  What can you do with us
    ...
    <div className="bg-white/20  backdrop-blur-lg p-6 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
      ...
      <h2 className="font-bold text-xl mb-2   bg-red-600 text-white font-josefin py-3 rounded-lg">Flexibility and Security Combined: MYOB Remote Access Solutions
      </h2>
    ...
    <div className="bg-white/20  backdrop-blur-lg p-6 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
      ...
      <h2 className="font-bold text-xl mb-2   bg-red-600 text-white font-josefin py-3 rounded-lg">Boost Productivity with Secure Empower Your Business: Achieve Financial Goals with MYOB Hosting
      </h2>
      <p className="text-gray-700  p-2 rounded-md shadow-lg  font-montserrat transition-all duration-300">
    ...
    <div className="bg-white/20  backdrop-blur-lg p-6 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
      ...
      <h2 className="font-bold text-xl mb-2   bg-red-600 text-white font-josefin py-3 rounded-lg">Efficiency Redefined: Elevate Your Business with Our MYOB Hosting Provider
      </h2>
      <p className="text-gray-700  p-2 rounded-md shadow-lg  font-montserrat transition-all duration-300">
    ...
    <div className="bg-white/20  backdrop-blur-lg p-6 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
      ...
      <h2 className="font-bold text-xl mb-2   bg-red-600 text-white font-josefin py-3 rounded-lg">Secure and Seamless: Manage Seamless Collaboration: Experience Cloud MYOB Excellence
      </h2>
      <p className="text-gray-700  p-2 rounded-md shadow-lg  font-montserrat transition-all duration-300">
