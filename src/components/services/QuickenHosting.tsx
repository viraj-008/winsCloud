...
const QuickenHosting = () => {
  ...
  <div className="p-3">
    ...
    <h1 className="text-center font-semibold font-serif text-gray-600 text-2xl">Unveiling the Benefits of Quicken Hosting Services for Streamlined Management</h1>
    {/* Text Section */}
    ...
    <div className=" w-[90%] mx-auto  flex justify-center mt-8">
      <img className="h-48 md:h-80 border-2 border-black rounded-lg object-cover" src="./images/logo/quicken.webp" alt="QuickBooks Hosting" />
    </div>
  </div>
  ...
  Advantages of Winscloud Quicken Hosting Solutions
    ...
    <p className="text-center px-4 font-montserrat">Quicken Hosting: Simplify finances, access anywhere, anytime, for peace of mind
</p>
    ...
    <div className="bg-white/20 backdrop-blur-lg p-6 hover:text-white hover:bg-green-500 transition-all duration-300 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
      ...
      <h2 className="font-bold text-xl mb-2 font-kanit">Multiple User Access
      </h2>
    ...
    <div className="bg-white/20 hover:bg-green-500 hover:text-white transition-all duration-300 backdrop-blur-lg p-6 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
      ...
      <h2 className="font-bold text-xl mb-2  font-kanit">Cross-Device Functionality
      </h2>
  ...
  What can you do with us
    ...
    <div className="bg-white/20  backdrop-blur-lg p-6 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
      ...
      <h2 className="font-bold text-xl mb-2   bg-red-600 text-white font-josefin py-3 rounded-lg">Driving Growth: Impact of What Efficient Financial Management: Quicken Hosting Providers Lead the Way
      </h2>
    ...
    <div className="bg-white/20  backdrop-blur-lg p-6 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
      ...
      <h2 className="font-bold text-xl mb-2   bg-red-600 text-white font-josefin py-3 rounded-lg">Boost Productivity with Secure Quickben Cloud Hosting Solutions
      </h2>
      <p className="text-gray-700  p-2 rounded-md shadow-lg  font-montserrat transition-all duration-300">
    ...
    <div className="bg-white/20  backdrop-blur-lg p-6 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
      ...
      <h2 className="font-bold text-xl mb-2   bg-red-600 text-white font-josefin py-3 rounded-lg">Efficiency Unleashed: Quicken Remote Server Simplifies Financial Management
      </h2>
      <p className="text-gray-700  p-2 rounded-md shadow-lg  font-montserrat transition-all duration-300">
    ...
    <div className="bg-white/20  backdrop-blur-lg p-6 border shadow-[4px_4px_10px_rgba(0,0,25,0.5)] rounded-lg text-center">
      ...
      <h2 className="font-bold text-xl mb-2   bg-red-600 text-white font-josefin py-3 rounded-lg">Secure and Seamless: Manage Your Money Online with Quicken
      </h2>
      <p className="text-gray-700  p-2 rounded-md shadow-lg  font-montserrat transition-all duration-300">
